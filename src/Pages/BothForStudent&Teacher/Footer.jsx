...
export default function Footer() {
  return (
    ...
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://learnsphere.web.app" class="hover:underline">Learn Sphere™</a>. All Rights Reserved.
    </span>
